...
public class Programa {
    public static void main(String[] args)
    {
        ...
        try (br)
        {
            System.out.print("Introdueix un nom per a l'arxiu ");
            // Indicam l'arxiu.
            ...
            ProcessBuilder PBfind = new ProcessBuilder("java", "src/Exercisi4/ExecutarFind.java", nomArxiu);
            ...
            ProcessBuilder PBdir = new ProcessBuilder("java", "src/Exercisi4/ExecutarDir.java", nomArxiu);
